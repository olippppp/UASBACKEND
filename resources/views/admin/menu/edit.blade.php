                ...
                margin-right: auto;">
                    <div class="col-md-7">
                        ...
                        <div class="form-item pt-4">
                            ...
                            <input type="text" class="form-control" required name="nama" value="{{ $menu->nama }}">
                        </div>
                        ...
                        <div class="form-item pt-2">
                            ...
                            <textarea type="text" class="form-control" id="deskripsi" name="deskripsi" required>{{ $menu->deskripsi }}</textarea>
                        </div>
                        <div class="form-item pt-2">
        ...
        if (!allowedExtensions.exec(filePath)) {
            ...
            if (fileInput.files && fileInput.files[0]) {
                ...
                reader.onload = function(e) {
                    document.getElementById('imagePreview').innerHTML = '<div>Foto Menu</div><img src="' + e
                        .target.result +
