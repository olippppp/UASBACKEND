...
@section('content')
    ...
    <div class="container-fluid page-header admin py-5">
        ...
        <ol class="breadcrumb justify-content-center mb-0">
            ...
            <li class="breadcrumb-item admin active text-white">Admin</li>
        </ol>
    </div>
    ...
    <div class="container-fluid py-5">
        <div class="container py-5">
            <div style="display: flex; justify-content: space-between;">
                ...
                <div class="col-xl-3">
                    <form id="search-form" action="{{ route('admin.admin') }}" method="GET">
            ...
            <div style="display: flex; margin-top: 20px;">
                <div class="pagination admin" style="margin-left: auto">
                    ...
                    @else
                        <a href="{{ $admin->appends(request()->query())->previousPageUrl() }}" class="prev-arrow rounded"><i
                    ...
                    @foreach ($admin->getUrlRange(1, $admin->lastPage()) as $page => $url)
                        @if ($page == $admin->currentPage())
                            <a href="{{ $admin->appends(request()->query())->url($page) }}"
                    ...
                    @if ($admin->hasMorePages())
                        <a href="{{ $admin->appends(request()->query())->nextPageUrl() }}" class="next-arrow rounded"><i
